        ...
        <div className="flex items-center gap-3 self-end sm:self-auto">
          <label className="relative hidden min-w-0 sm:block sm:w-[256px]">
            ...
            <input
              ...
              className="h-9 w-full rounded-full border border-transparent bg-[color:var(--surface-subtle)] pl-11 pr-4 text-sm text-[color:var(--foreground)] outline-none transition placeholder:text-[color:var(--muted)] focus:border-[color:var(--line-strong)] focus:bg-white focus:ring-2 focus:ring-[color:var(--accent-soft)]"
            />
          </label>
          ...
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full text-[color:var(--muted-strong)] transition hover:bg-[color:var(--surface-subtle)] hover:text-[color:var(--foreground)] focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-soft)]"
          >
