...
export function UploadedDocumentsCard({
  ...
  return (
    <section className="flex min-h-[320px] flex-col rounded-[24px] bg-[color:var(--surface-strong)] p-6 shadow-[var(--shadow-card)] sm:p-7">
      <div className="flex items-start justify-between gap-4">
        ...
        {countLabel ? (
          <span className="inline-flex items-center rounded-full bg-[rgba(196,166,106,0.22)] px-3 py-1 text-xs font-semibold text-[color:var(--warning-text)]">
            {countLabel}
          </span>
        ) : null}
      </div>
      ...
      {hasItems ? (
        ...
        <div className="mt-6 flex flex-1 items-center justify-center rounded-[20px] border border-dashed border-[color:var(--line-strong)] bg-[color:var(--surface-subtle)] p-8">
          <div className="mx-auto flex max-w-sm flex-col items-center text-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white text-[color:var(--muted)] shadow-[var(--shadow-soft)]">
